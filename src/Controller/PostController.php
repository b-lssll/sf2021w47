...
class PostController extends AbstractController
{
     ...
     */
    public function create(Request $request, EntityManagerInterface $manager, AuthorSecurity $authorSecurity): Response
    {
        $post = (new Post())
    ...
    public function delete(Post $post, Request $request, EntityManagerInterface $manager): Response
    {
        $form = $this->createFormBuilder(null, [
            ...
            ->add('challenge', TextType::class, [
                'label' => false,
                'help' => 'Veuillez recopier le titre de la publication: <kbd>'.htmlspecialchars($post->getTitle()).'</kbd>',
                'help_html' => true,
